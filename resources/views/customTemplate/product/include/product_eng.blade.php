        ...
        <div class="row">
            ...
            <div class="col-lg-5 order-3">
                <div class="product_description">
                    ...
                    <div class="product_name">{{$product->product_name_eng}}</div>
                    <h4>Deal Code : {{$product->id}}</h4>
                    {{--<h6>Uploaded by <i><a href="{{URL::to('/shopper-product/'.$shopper->id)}}">{{$shopper->user_name}}</a></i></h6>--}}

                    <div class="product_text text-justify"><p>{{$product->product_short_description_eng}}</p></div>
                        ...
                        @foreach($reletedProducts as $reletedProduct)
                            <div class="row">
                                <div class="col-7">
                                    ...
                                    <a href="{{URL::to('/product-view-by-id/'.$reletedProduct->id)}}"><button class="btn btn-info">add to cart</button></a>
                                </div>
